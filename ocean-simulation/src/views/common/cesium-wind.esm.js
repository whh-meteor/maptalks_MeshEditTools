...
class CesiumWind {
  ...
  //   const sceneCoor = SceneTransforms.wgs84ToWindowCoordinates(scene, position)
  ...
  project(coordinate) {
    try {
      ...
      console.error('Error in project method: ', error)
      // 如果需要，你可以返回一个默认值或者 null，以避免调用处出现进一步的错误
      return null
    }
  }
